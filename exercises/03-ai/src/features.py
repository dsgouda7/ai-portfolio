...
class TextPreprocessor:
    ...
    def preprocess(self, text: str) -> str:
        ...
        📖 See: notes/03-ai/ch05-prompt-engineering/ (text normalization)
                notes/03-ai/ch07-rag-and-embeddings/ (preparing text for embeddings)
    ...
    def preprocess_batch(self, texts: List[str]) -> List[str]:
        ...
        📖 See: notes/03-ai/ch07-rag-and-embeddings/ (batch processing for RAG)
...
class EmbeddingGenerator:
    ...
    def load(self):
        ...
        📖 See: notes/03-ai/ch07-rag-and-embeddings/ (sentence transformers, embedding models)
    ...
    def encode(self, text: str) -> np.ndarray:
        ...
        📖 See: notes/03-ai/ch07-rag-and-embeddings/ (vector embeddings, cosine similarity)
    ...
    def encode_batch(
        ...
        📖 See: notes/03-ai/ch07-rag-and-embeddings/ (batch embedding generation)
...
class VectorDatabase:
    ...
    def create(self, embedding_dim: int):
        ...
        📖 See: notes/03-ai/ch08-vector-dbs/ (ChromaDB, FAISS, indexing strategies)
    ...
    def add_documents(
        ...
        📖 See: notes/03-ai/ch08-vector-dbs/ (indexing documents, metadata storage)
