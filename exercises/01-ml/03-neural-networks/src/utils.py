"""Utility functions for UnifiedAI
...
def setup_logging(log_level: str = "INFO", log_file: str = None) -> logging.Logger:
    ...
    Example:
        >>> logger = setup_logging("INFO", "logs/unifiedai.log")
...
def validate_in_range(
    ...
    Args:
        ...
        inclusive: Whether endpoints are included
    
    Raises:
        ValueError: If value is outside range
    
    Example:
        >>> validate_in_range(0.2, "test_size", 0.0, 1.0)
    """
    if inclusive:
...
def validate_positive(value: float, name: str) -> None:
    ...
    Example:
        >>> validate_positive(0.01, "learning_rate")
    """
    if value <= 0:
