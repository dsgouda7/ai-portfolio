...
def setup_logging(log_level: str = "INFO", log_file: str = None) -> logging.Logger:
    ...
    Example:
        >>> logger = setup_logging("INFO", "logs/flixai.log")
...
def validate_positive(value: float, name: str) -> None:
    ...
    Example:
        >>> validate_positive(0.5, "alpha")  # OK
        >>> validate_positive(-1.0, "alpha")  # Raises ValueError
    """
    if value <= 0:
...
def validate_in_range(value: float, name: str, min_val: float, max_val: float) -> None:
    """Validate that a value is in a specific range.
    ...
    Example:
        >>> validate_in_range(0.2, "test_size", 0.0, 1.0)  # OK
