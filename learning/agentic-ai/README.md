...
1. GenAI foundations: [Transformer architecture](../genai/01-transformers/), [LLM fine-tuning](../genai/02-llm-finetuning/), [RAG](../genai/03-rag/), and [LLM evaluation](../genai/04-llm-evaluation/).
2. Python 3.12.
...
| 02a | [Skills: Discovery, Composition, and Versioning](02a-skills-discovery-composition-and-versioning/02a-skills-discovery-composition-and-versioning.ipynb) · [Theory notes](02a-skills-discovery-composition-and-versioning/02a-skills-discovery-composition-and-versioning-theory.md) | Copied know-how floats across tool versions and silently changes decisions | Gated discovery, pinned dependencies, evaluated promotion, deterministic conflicts, and named rollback |
