...
KERNEL_NAME="ai-engineer-03-latency-cost"
KERNEL_DISPLAY_NAME="Python (AI Engineer 03 Latency and Cost .venv)"
...
echo ""
echo "Setup complete for AI Engineer 03 Latency and Cost."
