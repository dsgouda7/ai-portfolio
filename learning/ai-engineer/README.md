...
|---|---|---|
| Fixture path is not found | Notebook started outside the repository tree or checkout is incomplete | Open the repository workspace, confirm `learning/ai-engineer/shared/` exists, and restart from the chapter README |
