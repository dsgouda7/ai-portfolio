...
KERNEL_NAME="ai-engineer-data-quality"
KERNEL_DISPLAY_NAME="Python (AI Engineer Data Quality .venv)"
...
echo ""
echo "Setup complete for AI Engineer Training Data Quality and Lineage."
echo "Virtual environment: $VENV_DIR"
echo "Jupyter kernel: $KERNEL_DISPLAY_NAME"
echo "Notebook cells were not executed."
