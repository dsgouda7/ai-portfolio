<#
.SYNOPSIS
    Creates the chapter-local environment for GenAI 08 Transformers.

.DESCRIPTION
    Creates or reuses `.venv` next to this script, installs every dependency
    from the adjacent requirements.txt, registers the `genai-08-transformers` Jupyter
...
$KernelName = "genai-08-transformers"
$KernelDisplayName = "Python (GenAI 08 Transformers .venv)"
...
Write-Host ""
Write-Host "Setup complete for GenAI 08 Transformers." -ForegroundColor Green
