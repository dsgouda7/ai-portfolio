...
.DESCRIPTION
    ...
    from the adjacent requirements.txt, registers the `genai-06-llm-gateway` Jupyter
...
$KernelName = "genai-06-llm-gateway"
$KernelDisplayName = "Python (GenAI 06 LLM Gateway .venv)"
...
Write-Host ""
Write-Host "Setup complete for GenAI 06 LLM Gateway." -ForegroundColor Green
