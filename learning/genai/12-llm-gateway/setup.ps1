<#
.SYNOPSIS
    Creates the chapter-local environment for GenAI 12 LLM Gateway.

.DESCRIPTION
    Creates or reuses `.venv` next to this script, installs every dependency
    from the adjacent requirements.txt, registers the `genai-12-llm-gateway` Jupyter
...
$KernelName = "genai-12-llm-gateway"
$KernelDisplayName = "Python (GenAI 12 LLM Gateway .venv)"
...
Write-Host ""
Write-Host "Setup complete for GenAI 12 LLM Gateway." -ForegroundColor Green
