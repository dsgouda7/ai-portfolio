<#
.SYNOPSIS
    Creates the chapter-local environment for GenAI 04 RAG.

.DESCRIPTION
    Creates or reuses `.venv` next to this script, installs every dependency
    from the adjacent requirements.txt, registers the `genai-04-rag` Jupyter
...
$KernelName = "genai-04-rag"
$KernelDisplayName = "Python (GenAI 04 RAG .venv)"
...
Write-Host ""
Write-Host "Setup complete for GenAI 04 RAG." -ForegroundColor Green
