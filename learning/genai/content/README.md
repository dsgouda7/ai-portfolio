...
The [GPU practice notebook](../02-llm-finetuning/04-llm-finetuning-practice.ipynb) uses an explicit eight-novel allowlist and reserves validation and test chapters before creating token blocks.
