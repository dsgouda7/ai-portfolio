<#
.SYNOPSIS
    Creates the chapter-local environment for GenAI 09 LLM Fine-Tuning.

.DESCRIPTION
    Creates or reuses `.venv` next to this script, installs every dependency
    from the adjacent requirements.txt, registers the `genai-09-llm-finetuning` Jupyter
...
$KernelName = "genai-09-llm-finetuning"
$KernelDisplayName = "Python (GenAI 09 LLM Fine-Tuning .venv)"
...
Write-Host ""
Write-Host "Setup complete for GenAI 09 LLM Fine-Tuning." -ForegroundColor Green
