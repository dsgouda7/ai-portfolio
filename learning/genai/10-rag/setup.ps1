<#
.SYNOPSIS
    Creates the chapter-local environment for GenAI 10 RAG.

.DESCRIPTION
    Creates or reuses `.venv` next to this script, installs every dependency
    from the adjacent requirements.txt, registers the `genai-10-rag` Jupyter
...
$KernelName = "genai-10-rag"
$KernelDisplayName = "Python (GenAI 10 RAG .venv)"
...
Write-Host ""
Write-Host "Setup complete for GenAI 10 RAG." -ForegroundColor Green
