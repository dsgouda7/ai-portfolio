...
Run the shared environment setup from [`../_llm-shared/`](../_llm-shared/README.md). The deeper general evaluation track remains in [`../05-llm-evaluation/`](../05-llm-evaluation/).
