...
| Hypothesis ID | Causal boundary | Falsifiable statement | Discriminating check | Result/evidence | Status |
|---|---|---|---|---|---|
| `HYP-01` | `<policy/data/retrieval/model/tool/identity/infrastructure>` | `<claim>` | `<cheapest safe check>` | `<pending or reference>` | `OPEN | SUPPORTED | FALSIFIED` |
