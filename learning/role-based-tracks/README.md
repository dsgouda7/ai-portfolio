...
|---:|---|---|
| 1 | [Fine-tuning data techniques](../genai/03-llm-finetuning/01-llm-finetuning-data-techniques.ipynb) | [Training Data Quality and Lineage](ai-engineer/01-training-data-quality-and-lineage/README.md) |
| 2 | [RAG evaluation](../genai/04-rag/05-rag-evaluation.ipynb) and [evaluation metrics](../genai/05-llm-evaluation/01-llm-evaluation-metrics-and-benchmarks.ipynb) | [Prompt Release and Experimentation](ai-engineer/02-prompt-release-and-experimentation/README.md) |
| 3 | [LLM gateway](../genai/06-llm-gateway/06-llm-gateway.ipynb) and [inference systems](../ai-infrastructure/07-inference-systems/inference-systems.ipynb) | [Application Latency and Cost](ai-engineer/03-application-latency-and-cost/README.md) |
| 4 | [Fine-tuning comparison and decision](../genai/03-llm-finetuning/03-llm-finetuning-comparison-and-decision.ipynb) | [Release Registry and Lineage](ai-engineer/04-release-registry-and-lineage/README.md) |
