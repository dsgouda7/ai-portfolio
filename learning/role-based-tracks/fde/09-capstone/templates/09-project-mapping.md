...
|---|---|---|---|---|---|---|
| `[AC/SEC/DATA/EVAL/etc.]` | `[path and version]` | `[implemented source / absent / deferred]` | `[static completed / live required / BLOCKER: owner must validate by gate]` | `[TODO]` | `[TODO]` | `[reuse / adapt / build / defer / remove]` |
