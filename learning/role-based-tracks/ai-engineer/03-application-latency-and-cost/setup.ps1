<#
.SYNOPSIS
    Creates the chapter-local environment for AI Engineer 03.

.DESCRIPTION
    Creates or reuses `.venv` next to this script, installs dependencies from
    requirements.txt, registers the chapter kernel, and assigns that kernel to
    every notebook in this directory.
...
$KernelName = "ai-engineer-03-latency-cost"
$KernelDisplayName = "Python (AI Engineer 03 Latency and Cost .venv)"
...
Write-Host ""
Write-Host "Setup complete for AI Engineer 03 Latency and Cost." -ForegroundColor Green
