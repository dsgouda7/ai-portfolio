...
| Retrieval and generation evaluation | [RAG](../../../genai/10-rag/README.md) and [LLM Evaluation](../../../genai/11-llm-evaluation/README.md) | Retrieval, generation/citation, and safety/authorization domains |
