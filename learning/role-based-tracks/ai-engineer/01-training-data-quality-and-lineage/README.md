...
- [Fine-Tuning: What Should the Model Learn?](../../../genai/02-llm-finetuning/01-llm-finetuning-data-techniques.ipynb) owns SFT, preference objectives, held-out evidence, and training manifests.
- [Fine-Tuning README](../../../genai/02-llm-finetuning/README.md) owns the adaptation arc and hardware boundary.
- [LLM Evaluation](../../../genai/04-llm-evaluation/README.md) owns evaluator validity, slice gates, and release thresholds.
