<#
.SYNOPSIS
    Creates the chapter-local environment for AI Engineer Prompt Release.

.DESCRIPTION
    Creates or reuses `.venv` next to this script, installs dependencies from
    requirements.txt, registers the chapter kernel, and assigns it to notebooks
    in this directory.
...
$KernelName = "ai-engineer-prompt-release"
$KernelDisplayName = "Python (AI Engineer Prompt Release .venv)"
...
Write-Host ""
Write-Host "Setup complete for AI Engineer Prompt Release." -ForegroundColor Green
