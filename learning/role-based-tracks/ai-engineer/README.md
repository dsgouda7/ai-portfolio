...
| 2. Model mechanics | Generation is wrong, but you cannot localize masking, attention, objective, or decoding | [PyTorch RNN bridge](../../genai-prerequisites/07-pytorch-rnn-bridge/01-pytorch-rnn-bridge.ipynb) and [Transformer foundations](../../genai/02-transformers/README.md) | Mechanism-level diagnosis with measured checks |
