<#
.SYNOPSIS
    Creates the chapter-local environment for GenAI Prerequisite 03 PyTorch Fundamentals.

.DESCRIPTION
    Creates or reuses `.venv` next to this script, installs every dependency
    from the adjacent requirements.txt, registers the `genai-prereq-03-pytorch` Jupyter
...
$KernelName = "genai-prereq-03-pytorch"
$KernelDisplayName = "Python (GenAI Prerequisite 03 PyTorch .venv)"
