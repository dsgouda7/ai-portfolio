<#
.SYNOPSIS
    Creates the chapter-local environment for GenAI Prerequisite 07 PyTorch RNN Bridge.

.DESCRIPTION
    Creates or reuses `.venv` next to this script, installs every dependency
    from the adjacent requirements.txt, registers the `genai-prereq-07-pytorch-rnn` Jupyter
...
$KernelName = "genai-prereq-07-pytorch-rnn"
$KernelDisplayName = "Python (GenAI Prerequisite 07 PyTorch RNN .venv)"
...
Write-Host ""
Write-Host "Setup complete for GenAI Prerequisite 07 PyTorch RNN Bridge." -ForegroundColor Green
