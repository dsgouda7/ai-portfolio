...
KERNEL_NAME="genai-prereq-07-pytorch-rnn"
KERNEL_DISPLAY_NAME="Python (GenAI Prerequisite 07 PyTorch RNN .venv)"
...
echo ""
echo "Setup complete for GenAI Prerequisite 07 PyTorch RNN Bridge."
