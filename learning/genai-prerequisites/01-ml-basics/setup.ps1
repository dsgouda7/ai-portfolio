...
.DESCRIPTION
    ...
    Jupyter kernel named "ml-basics" pointing at that venv. Select the
    "Python (ml-basics .venv)" kernel in VS Code to use it.
...
if (-not $SkipKernel) {
    Write-Host "Registering Jupyter kernel 'ml-basics'..."
    & $VenvPython -m ipykernel install --user --name ml-basics --display-name "Python (ml-basics .venv)"
}

Write-Host "`nSetup complete." -ForegroundColor Green
Write-Host "Open ml-basics.ipynb and pick the 'Python (ml-basics .venv)' kernel."
