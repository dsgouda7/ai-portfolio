...
# Jupyter kernel named "ml-basics" pointing at that venv. The notebook's
...
if [ "$SKIP_KERNEL" -eq 0 ]; then
    echo "Registering Jupyter kernel 'ml-basics'..."
    "$VENV_PYTHON" -m ipykernel install --user --name ml-basics --display-name "Python (ml-basics .venv)"
fi

echo ""
echo "Setup complete."
echo "Open ml-basics.ipynb and pick the 'Python (ml-basics .venv)' kernel"
