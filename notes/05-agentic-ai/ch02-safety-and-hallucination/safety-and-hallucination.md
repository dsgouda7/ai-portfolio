...
- **Open-domain** → Retrieval-Augmented Generation ([RAG](../ch10-rag-and-embeddings)) *converts* open-domain queries into closed-domain ones — retrieve the ground truth first, then generate against it. If retrieval fails, fail-safe to "I don't have that information."
