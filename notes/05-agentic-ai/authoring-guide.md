...
> **This document tracks the chapter-by-chapter structure of the Agentic AI notes library (05-agentic-ai).**
> Each chapter lives under `notes/05-agentic-ai/` in its own folder.
> Read this before editing any chapter to keep tone, structure, and the running example consistent.

<!-- LLM-STYLE-FINGERPRINT-V1
canonical_chapters: ["notes/05-agentic-ai/ch01-react-and-semantic-kernel/react-and-semantic-kernel.md", "notes/05-agentic-ai/ch02-safety-and-hallucination/safety-and-hallucination.md"]
...
The Agentic AI track covers 6 core chapters: everything from tool-calling orchestration to multi-agent production architecture. This track builds directly on [LLM Fundamentals (03-ai)](../03-ai).
