...
→ DECISION: → DECISION: → DECISION: → DECISION:
 ...
 • Non-convex: try check if at saddle • No: reduce η or • max_iters: Retry
...
**What to do next:**
→ **If |∇L| > 1000:** Verify gradient formula — unusually large gradients often indicate coding errors (e.g., forgot to normalize inputs)
...
for iteration in range(max_iters):
 ...
 print(f" Reached max_iters={max_iters} without convergence")
