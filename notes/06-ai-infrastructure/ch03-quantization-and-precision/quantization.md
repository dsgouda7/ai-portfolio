...
├─────────────────────────────────────────┤
│ Available headroom │ 2.0 GB │ Too small for batch=2 (needs 4 GB KV)
└─────────────────────────────────────────┘
...
│ Latency (p50) │ 280 ms │ 420 ms │ +50% │
│ Latency (p95) │ 450 ms │ 1,200 ms │ +167% │
│ Accuracy │ 97.4% │ 96.2% │ -1.2% │
└─────────────────────┴──────────────┴──────────────┴────────────┘
Wins: 75% memory savings, 4× throughput, hits 10k req/day target
Costs: +140ms p50 latency (but still <2s), -1.2% accuracy (but still >95%)
...
> Always use domain-representative calibration data. Using generic WikiText on a code-generation model causes unnecessary accuracy loss.
