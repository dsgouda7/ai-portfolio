...
- [`../../../learning/genai/03-llm-finetuning/`](../../../learning/genai/03-llm-finetuning/)
  owns adaptation objectives and held-out evidence.
- [`../../../learning/genai/04-rag/`](../../../learning/genai/04-rag/) owns retrieval,
  citation, refusal, and authorization evaluation concepts.
- [`../../../learning/genai/05-llm-evaluation/`](../../../learning/genai/05-llm-evaluation/)
  owns evaluator design and uncertainty.
- [`../../../learning/genai/06-llm-gateway/`](../../../learning/genai/06-llm-gateway/)
