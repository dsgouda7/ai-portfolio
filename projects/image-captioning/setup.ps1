#!/usr/bin/env pwsh
# Creates a local .venv and installs the dependencies for ibm_genai_image_captioning.py
...
Write-Host "Run the app with: $VenvPython ibm_genai_image_captioning.py"
